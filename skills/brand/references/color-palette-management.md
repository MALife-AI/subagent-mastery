...
|------|-----|-----|-----|-------|
| Mirae Asset Orange | #F58220 | rgb(245,130,32) | hsl(28,92%,54%) | CTAs, 핵심 강조 |
| Mirae Asset Blue | #043B72 | rgb(4,59,114) | hsl(210,93%,23%) | 텍스트, 네비게이션 |
```

### CSS Variables
```css
:root {
  /* Primary - Mirae Asset Orange */
  --color-primary: #F58220;
  --color-primary-light: #FAAF72;
  --color-primary-dark: #CB6015;

  /* Secondary - Mirae Asset Blue */
  --color-secondary: #043B72;
  --color-secondary-light: #00A9CF;
  --color-accent: #0086B8;

  /* Neutral */
  --color-background: #FFFFFF;
  --color-surface: #E5E4E1;
  --color-text-primary: #043B72;
  --color-text-secondary: #48535B;
  --color-border: #CDCECB;
  --color-footer-bg: #ECEFF4;
}
```
...
### Professional/Corporate (미래에셋)
```
Primary: #F58220 (Mirae Asset Orange)
Secondary: #043B72 (Mirae Asset Blue)
Accent: #FAAF72 (Orange Light 60%)
Background: #ECEFF4
Text: #043B72
```
